...
public class TaskEngine {
    ...
    private Map<String, TaskNode> allTaskNodeMap = new ConcurrentHashMap<String, TaskNode>();// default
                                                                                             // mode
            ...
            if (childTaskNodeList != null && !childTaskNodeList.isEmpty()) {
                ...
                for (TaskNode childTaskNode : childTaskNodeList) {
                    if (excludeTaskNodeNameMap.containsKey(childTaskNode.getName())) {
                        ...
                        // first delete the parent child relation,and keep the
                        // parent reference for last iterator
                        ...
                        // second delete the child child relation,and keep the
                        // child child reference for last iterator
    ...
    /**
     * @param taskNodeTimeFile
     *            the taskNodeTimeFile to set
     */
